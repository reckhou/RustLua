...
function loadLocalization(setting)
	...
	LocalTxt["english"] = {}
	LocalTxt["english"].kickChatColor = " 被踢出服务器 ( 名字不能包含彩色字符 ) "
	LocalTxt["english"].kickNoticeColor = "被踢出:名字不能包含彩色字符"
	LocalTxt["english"].kickChatDuplicate = " 被踢出服务器 ( 名字已被使用 ) "
	LocalTxt["english"].kickNoticeDuplicate = "被踢出:名字已被使用"
	LocalTxt["english"].kickChatCharacter = " 被踢出服务器 ( 名字只能包含英文 ) "
	LocalTxt["english"].kickNoticeCharacter = "被踢出:名字只能包含英文"
